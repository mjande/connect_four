...
describe Game do
  describe '#start_game' do
    ...
    let(:board) { double('board', display_board: nil) }
    let(:player1) do
      double('player1', welcome: nil, assign_name: nil, assign_symbol: nil)
    end
    let(:player2) do
      double('player2', welcome: nil, assign_name: nil, assign_symbol: nil)
    end
  ...
  describe '#play game' do
    ...
    let(:player1) { double('player1', turn_input: 0, symbol: '○', number: 1, win_message: nil, tie_message: nil) }
    let(:player2) { double('player2', turn_input: nil, symbol: nil, number: 2, win_message: nil) }
  ...
  describe '#end_game' do
    ...
    before do
      ...
      end_game.instance_variable_set(:@player1, player1)
      allow(end_game.instance_variable_get(:@board)).to receive(:display)
    end
